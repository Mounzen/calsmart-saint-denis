...
const MAPPINGS = {
  ...
  logements: [
    ...
    ["surface", ["surface", "superficie", "m2", "m²"]],
...
function normalizeOuiNon(val) {
  if (!val) return false;
  return ["oui","yes","o","1","true","x","✓","vrai","favorable","complet"].includes(
  ...
  return <div style={{ fontFamily:F.b }}>
    ...
    <div style={{ marginBottom:28 }}>
      ...
      <p style={{ color:C.muted, fontSize:12.5 }}>
        Importe tes données CSV exportées depuis AFI-Pelehas directement dans CAL Smart.</p>
    </div>
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between",
          ...
          <div>
            ...
            <div style={{ fontSize:12, color:C.muted, marginTop:2 }}>
              Vérifiez la correspondance entre les colonnes Pelehas et les champs CAL Smart.
                ...
                {preview.slice(0,15).map((row,i)=>(
                  <tr key={i} style={{ borderBottom:`1px solid ${C.border}`,
                    ...
                    {type==="demandeurs"&&<>
                      ...
                      <td style={{ padding:"8px 12px", color:C.text }}>{row.rev>0?`${row.rev.toLocaleString()} €`:"—"}</td>
                      <td style={{ padding:"8px 12px" }}>
    ...
    {step===5&&(
      <div style={{ textAlign:"center", padding:20 }}>
        ...
        <div style={{ fontSize:13, color:C.muted, marginBottom:24, lineHeight:1.6 }}>
          ...
          <br/>
          Les données sont maintenant disponibles dans CAL Smart.
        </div>
