...
function Spin() {
  return <div style={{display:"flex",alignItems:"center",justifyContent:"center",
    ...
    <span style={{marginRight:8,fontSize:18,display:"inline-block",
      animation:"spin 1s linear infinite"}}>⟳</span>Chargement…
...
export default function Statistiques() {
  ...
  const TABS=[
    {id:"demandeurs",label:"👥 Demandeurs"},
    {id:"attributions",label:"🏠 Attributions"},
    {id:"territoire",label:"🗺️ Territoire"},
    {id:"elus",label:"⊛ Élus"},
    ...
    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:20}}>
      ...
      {importResult&&(
        <div style={{padding:"8px 14px",background:C.greenBg,borderRadius:9,
          ...
          ✓ {importResult.ok} audiences importées
